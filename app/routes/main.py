...
from app.common import (
    ...
    requireLogin, getRecipeByID, getNextID, getNow, bookmarks, socialPosts, findUserByID, buildRecipeCard, formatDateTime, buildRecipeDetail
)
...
def socialPage():
    ...
    recipe_list = recipe_service.get_recipe_list(limit=50) # 가져올 레시피 개수 제한
    availableRecipes = [{"recipeID": r["recipeID"], "recipeName": r["recipeName"]} for r in recipe_list]
    socialPostViewList = []
